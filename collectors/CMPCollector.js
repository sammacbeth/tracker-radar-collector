...
/**
 * @type {import('@cliqz/autoconsent/lib/node')}
 */
// @ts-ignore
const autoconsent = require('@cliqz/autoconsent/dist/autoconsent.puppet');
const extraRules = require('@cliqz/autoconsent/rules/rules.json');

/**
 * @type {Object.<string, import('@cliqz/autoconsent/lib/consentomatic/').ConsentOMaticConfig>}}
 */
